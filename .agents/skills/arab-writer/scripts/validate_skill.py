...
required=['SKILL.md','agents/openai.yaml','references/arabic-core.md','references/quality-gates.md','references/fidelity-guard.md','references/document-mode.md','references/voice-profile.md','scripts/protected_tokens.py','scripts/anchored_facts.py','scripts/semantic_sentinels.py','scripts/structure_guard.py','scripts/arabic_mechanical_lint.py','scripts/qa_pair.py']
errors=[]
for rel in required:
...
print('OK: Arab Writer v1.1 structure is valid.')
